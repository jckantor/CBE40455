...
- [3.1 Production Models with Constraints](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb)
    - [Example: Production Plan for a Single Product Plant](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb#Example:-Production-Plan-for-a-Single-Product-Plant)
        - [Pyomo Model](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb#Pyomo-Model)
        - [Exercises](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb#Exercises)
    - [Production Plan: Product Y](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb#Production-Plan:-Product-Y)
        - [Exercises](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb#Exercises)
    - [Production Plan: Mixed Product Strategy](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb#Production-Plan:-Mixed-Product-Strategy)
    - [What are the active constraints?](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb#What-are-the-active-constraints?)
    - [What is the incremental value of labor?](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb#What-is-the-incremental-value-of-labor?)
    - [Theory of Constraints](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.01-Production-Models-with-Constraints-(Pyomo).ipynb#Theory-of-Constraints)
- [3.2 Transportation Networks](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb)
    - [Background](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb#Background)
    - [Pyomo Model](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb#Pyomo-Model)
        - [Data File](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb#Data-File)
        - [Model File](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb#Model-File)
    - [Solution](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb#Solution)
    - [Sensitivity Analysis](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb#Sensitivity-Analysis)
            - [Analysis by Source](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb#Analysis-by-Source)
            - [Analysis by Customer](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb#Analysis-by-Customer)
        - [Exercises](http://nbviewer.jupyter.org/github/jckantor/CBE40455/blob/master/notebooks/03.02-Transportation-Networks-(Pyomo).ipynb#Exercises)
